...
step_time = 30  # len for the time serie segment  [Seconds]->>>>>>>>> Change it to zoom in the signal time!!
...
def getEnvelope(inputSignal):
    ...
    intervalLength = 200  # change this number depending on your Signal frequency content and time scale
    outputSignal = []
